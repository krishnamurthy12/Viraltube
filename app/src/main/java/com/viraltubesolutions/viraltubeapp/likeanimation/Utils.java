package com.viraltubesolutions.viraltubeapp.likeanimation;
...
public class Utils {
    ...
    public static List<com.viraltubesolutions.viraltubeapp.likeanimation.Icon> getIcons() {
        List<com.viraltubesolutions.viraltubeapp.likeanimation.Icon> icons = new ArrayList<>();
        icons.add(new com.viraltubesolutions.viraltubeapp.likeanimation.Icon(R.drawable.vote1, R.drawable.vote, com.viraltubesolutions.viraltubeapp.likeanimation.IconType.Heart));
       // icons.add(new com.viraltubesolutions.viraltubeapp.likeanimation.Icon(R.drawable.star_on, R.drawable.star_off, com.viraltubesolutions.viraltubeapp.likeanimation.IconType.Star));
        //icons.add(new com.like.Icon(R.drawable.thumb_on, R.drawable.thumb_off, IconType.Thumb));
